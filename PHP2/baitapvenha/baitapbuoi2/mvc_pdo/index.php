...
<html lang="">
	<head>
		...
		<link rel="stylesheet" href="access/css/my_css.css">
	</head>
	<body>
		<div class="container">
				...
				<div class="col-md-12">
					...
					<div class="col-md-9">
						<?php 
							...
							switch ($page) {
								case 'add_member':
									include 'controller/student_c.php';
									$student = new student_c();
									$student->addStudent_c();
									break;

								case 'edit_member':
									include 'controller/student_c.php';
									$student = new student_c();
									$student->editStudent_c();
									break;
								case 'del_member':
									include 'controller/student_c.php';
									$student = new student_c();
									$student->delStudent_c();
									break;

								case 'trang_chu':
									include 'controller/student_c.php';
									$student = new student_c();
									$student->getStudent_c();
									break;
		...
		<script src="access/js/myJava.js"></script>
